	...
	void MostrarArbolBPorNiveles(struct Nodo *Raiz,int X);
	...
	void MostrarArbolBPorNiveles(struct Nodo *Ptr, int Vacios)
	{
		if(Ptr)
		{
			...
			for(i = 0; i <= Ptr -> N; i++)
			{
				MostrarArbolBPorNiveles(Ptr -> P[i], Vacios + 10);
			}
	...
	void Menu()
	{
		system("cls");
        cout<< "\n" <<endl;
		cout<< "     Arbol B: Tarea 5\n" <<endl;
		cout<< "          1. Insertar Clave\n" <<endl;
		cout<< "          2. Mostrar Arbol B Por Niveles\n" <<endl;
		cout<< "          3. Recorrer Arbol B De Manera Descendente\n" <<endl;
		cout<< "          4. Salir \n" <<endl;
		...
		while(Op != 4)
		{
			switch(Op)
			{
				...
				case 2:
					if(Band == 1)
					{
						printf("\t\t\t Arbol B Por Niveles: ");
						printf("\n");
						MostrarArbolBPorNiveles(Raiz, 0);
					}
					else
					{
                ...
                case 3:
					if(Band == 1)
					{
						printf("\t\t\t El Recorrido De Manera Descendente Es : ");
						printf("\n");
